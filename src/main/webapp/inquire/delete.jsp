    ...
    <input type='hidden' name='nowPage' id='nowPage' value='${param.nowPage }'>
      ...
      <div class="form-group">   
        <div class="col-md-12" style='text-align: center; margin: 30px;'>
          <DIV class='message'>
          삭제 되는 1:1문의: ${inquireVO.inquire_title }<br><br>
          삭제하시겠습니까? 삭제하시면 복구 할 수 없습니다.<br><br>
       
        <div class="form-group">   
        <div class="col-md-12">
          <input type='password' class="form-control" name='inquire_passwd'  value='' placeholder="패스워드" style='width: 20%; margin: 10px auto;'>
        </div>
      </div>
