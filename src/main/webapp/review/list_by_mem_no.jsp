...
//▶ 리뷰 삭제
  ...
  function review_update(review_no) {
    ...
    layer += "  " + row.rdate;
    msg += " <A href='javascript:review_update_proc("+row.review_no+")'>[x]</A>";
    layer += "  " + "<br>";
...
<jsp:include page="/menu/top.jsp" flush='false' />
  ...
  <TR>
    <TH class='th'>결제 번호 <br> payment_no</TH>
    <TH class='th'>상품 <br> at_name</TH>
    <TH class='th'>결제 가격<br> payment_total</TH>
    <TH class='th'>리뷰 <br> review_word</TH>
    <TH class='th'>평점 <br> review_rate</TH>
    <TH class='th'>등록일 <br> rdate</TH>
    <TH class='th'></TH>
  </TR>
 
  <c:forEach var="list" items="${list }">
    <c:set var="payment_no" value ="${list.payment_no}" />
    ...
    <c:set var="rdate" value ="${list.rdate}" />
      ...
      <TR>
      <TD class='td'>${payment_no}</TD>
      <TD class='td'><A href="./read.do?mem_wish_no=${list.at_no}">${at_no}</A></TD>
      <TD class='td'><A href="../payment/read.do?payment_no=${payment_no}">${payment_no}</A></TD>
      ...
      <TD class='td'>${rdate}</TD>
      <TD class='td'> 
        <button type="button" onclick="review_delete ('${review_no}')" >삭제</button>
        <button type="button" onclick="review_update ('${review_no}')" >수정</button>
      </TD>
      </TR>
    </c:forEach>
