    ...
    <FORM name='review_frm' id='review_frm'> <%-- 댓글 등록 폼 --%>
     ...
     <fieldset>
      <span class="star-cb-group">
        <input type="radio" id="rating-5" name="review_rate" value="5" />
        <label for="rating-5"></label>
        <input type="radio" id="rating-4" name="review_rate" value="4" checked="checked" />
        <label for="rating-4"></label>
        <input type="radio" id="rating-3" name="review_rate" value="3" />
        <label for="rating-3"></label>
        <input type="radio" id="rating-2" name="review_rate" value="2" />
        <label for="rating-2"></label>
        <input type="radio" id="rating-1" name="review_rate" value="1" />
