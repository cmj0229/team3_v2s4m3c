  ...
  <DIV id='panel_update' style='padding: 10px 0px 10px 0px; background-color: #F9F9F9; width: 100%; text-align: center;'>
    <FORM name='frm' id='frm' method='POST' action='./surv_item_update.do'>
      ...
      <div class="form-group">
         <label class="control-label col-md-3">문항</label>
          <div class="col-md-9">
           <input type="text" class="form-control" name="surv_item_ans" id="surv_item_ans" placeholder="" value="${surv_Item_VO.surv_item_ans }" required >
          </div>
       </div>
