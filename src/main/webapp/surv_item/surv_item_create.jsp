    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" id='btn_add' class="btn btn-default" data-dismiss="modal">항목추가등록</button>
 ...
 <input type='hidden' name='surv_no' value='${param.surv_no }'>
    ...
    <div class="form-group">
         <label class="control-label col-md-3">답변</label>
          <div class="col-md-9">
           <input type="text" class="form-control" name="surv_item_ans" id="surv_item_ans" placeholder="" value="" required >
          </div>
       </div>
   ...
   <DIV style='text-align: right;'>
     ...
     <button type="button" 
                  onclick="location.href='../surv/surv_list.do'" 
