...
SELECT surv_choice_no, surv_item_no, surv_ans_1, surv_ans_2, surv_ans_3, surv_ans_4, surv_choice_passwd
FROM surv_choice
ORDER BY surv_choice_no DESC;
...
FROM surv_choice
WHERE surv_item_no=1 AND SURV_CHOICE_PASSWD='1234';
