...
//    }
   ...
   * @return
   */
  @RequestMapping(value = "/surv/update_seqno_up.do", method = RequestMethod.GET)
  public ModelAndView update_seqno_up(int surv_no) {
    ModelAndView mav = new ModelAndView();
    
    Surv_VO surv_VO = this.surv_Proc.surv_read(surv_no);
    mav.addObject("surv_VO", surv_VO);
    
    int cnt = this.surv_Proc.surv_update_seqno_up(surv_no);
    mav.addObject("cnt",cnt);
    
    mav.setViewName("/surv/update_seqno_up_msg");
   ...
   * @return
   */
  @RequestMapping(value = "/surv/update_seqno_down.do", method = RequestMethod.GET)
  public ModelAndView update_seqno_down(int surv_no) { 
    ModelAndView mav = new ModelAndView();
    
    Surv_VO surv_VO = this.surv_Proc.surv_read(surv_no);
    mav.addObject("surv_VO", surv_VO);
    
    int cnt = this.surv_Proc.surv_update_seqno_down(surv_no);
    mav.addObject("cnt",cnt);
    
    mav.setViewName("/surv/update_seqno_down_msg");
    return mav;
  }
}
