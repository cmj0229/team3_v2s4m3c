...
//http:localhost:9090/team3/surv_item/surv_item_list.do
  ...
  @RequestMapping(value="/surv_item/surv_item_list.do", method = RequestMethod.GET)
    public ModelAndView surv_item_list(int surv_no) {
      ModelAndView mav = new ModelAndView();
        List<Surv_Item_VO> surv_item_list = null;
        surv_item_list = this.surv_Item_Proc.surv_item_list(surv_no);
        mav.addObject("surv_item_list", surv_item_list);
   ...
   * @return
   */
//  @RequestMapping(value="/surv_item/submit_list.do", method = RequestMethod.GET)
//    public ModelAndView submit_list(int surv_no) {
//      ModelAndView mav = new ModelAndView();
//      
//      Surv_Surv_Item_VO surv_Surv_Item_VO = this.surv_Item_Proc.submit_list(surv_no);
//      mav.addObject("surv_Surv_Item_VO",surv_Surv_Item_VO);
//      
//      mav.setViewName("/surv_item/submit_list");
//      return mav;
//    }
   ...
   * @return
   */
//  @RequestMapping(value="/surv_item/submit_proc.do", method = RequestMethod.POST)
//  public ModelAndView submit_list(Surv_Surv_Item_VO surv_Surv_Item_VO) {
//    ModelAndView mav = new ModelAndView();
//    
//    
//    return mav;
...
//   public ModelAndView surv_read_all(int surv_no) {
//    ModelAndView mav = new ModelAndView();
//    
//    List<Surv_Surv_Item_VO> list = this.surv_Item_Proc.surv_read_all(surv_no);
//    mav.addObject("list",list);
//    
//    
////     Surv_Surv_Item_VO surv_Surv_Item_VO = this.surv_Item_Proc.surv_read_all(surv_no);
////     mav.addObject("surv_Surv_Item_VO", surv_Surv_Item_VO);
////     
...
//  }
 ...
 @ResponseBody
 @RequestMapping(value="/surv_item/submit_proc.do", method=RequestMethod.POST)
   public String surv_item_cnt(int surv_item_no) {
   ModelAndView mav = new ModelAndView();
  
   System.out.println("surv_item_no:" + surv_item_no);
   int cnt = this.surv_Item_Proc.surv_item_cnt(surv_item_no);
   mav.addObject("cnt",cnt);
