...
@Autowired
  ...
  public List<Surv_Item_VO> surv_item_list(int surv_no) {
    ...
    surv_item_list = this.surv_Item_DAO.surv_item_list(surv_no);
  ...
  public List<Surv_Surv_Item_VO> surv_read_all(int surv_no) {
    List<Surv_Surv_Item_VO> list = this.surv_Item_DAO.surv_read_all(surv_no);
    return list;
  }

  @Override
  public int surv_item_response(Surv_Item_VO surv_Item_VO) {
    int cnt = this.surv_Item_DAO.surv_item_response(surv_Item_VO);
    return cnt;
  }

  @Override
  public Surv_Surv_Item_VO submit_list(int surv_no) {
    Surv_Surv_Item_VO surv_Surv_Item_VO = this.surv_Item_DAO.submit_list(surv_no);
    return surv_Surv_Item_VO;
  }

  @Override
  public int surv_item_cnt(int surv_item_no) {
    int cnt = this.surv_Item_DAO.surv_item_cnt(surv_item_no);
    return cnt;
  }
